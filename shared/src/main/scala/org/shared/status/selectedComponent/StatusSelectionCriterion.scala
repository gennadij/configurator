 ...
 */
sealed abstract class StatusSelectionCriterion extends Status
 ...
 */
case class NotAllowNextComponent() extends StatusSelectionCriterion {
 ...
 * Created by Gennadi Heimann Nov 19, 2017
 */
case class RequireComponent() extends StatusSelectionCriterion{
 ...
 * Created by Gennadi Heimann Nov 19, 2017
 */
case class RequireNextStep() extends StatusSelectionCriterion{
 ...
 */
case class AllowNextComponent() extends StatusSelectionCriterion{
  def status: String = "ALLOW_NEXT_COMPONENT"
  def message: String = "Sie koennen weitere Komponente auswaelen"
}

case class ErrorSelectionCriterion() extends StatusSelectionCriterion{
