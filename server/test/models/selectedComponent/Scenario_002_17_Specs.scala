...
class Scenario_002_17_Specs extends Specification with MessageHandler with BeforeAfterAll{
  ...
  "Specification for scenario 17" >> {
    "S1 -> C1, C2 | S2 -> C2" >> {
      ...
      (((jsonNextStepOut \ "result" \ JsonKey.step \ "components")(0)) \ "nameToShow").asOpt[String].get === "C21"
      (((jsonNextStepOut \ "result" \ JsonKey.step \ "components")(1)) \ "nameToShow").asOpt[String].get === "C22"
