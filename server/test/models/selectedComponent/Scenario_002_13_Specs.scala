...
class Scenario_002_13_Specs extends Specification with MessageHandler with BeforeAfterAll{
  ...
  "Specification spezifiziert der NextStep der Konfiguration" >> {
    "S1 -> C1, C2, C3, C1, C2, C3, C1, C2" >> {
      ...
      (componentOut_1 \ JsonKey.result \ "status" \JsonKey.excludeDependencyInternal \ "status").asOpt[String] === Some(NotExcludedComponentInternal().status)
      (componentOut_1 \ JsonKey.result \ "status" \"common" \ "status").asOpt[String].get === "SUCCESS"
      ...
      val componentIdC12: String = (startConfigOut \ JsonKey.result \ JsonKey.step \ "components").asOpt[List[JsValue]].get
      ...
      val componentIdC13: String = (startConfigOut \ JsonKey.result \ JsonKey.step \ "components").asOpt[List[JsValue]].get
      ...
      (componentOut_3 \ JsonKey.result \ "status" \"selectedComponent" \ "status").asOpt[String].get === "NOT_ALLOWED_COMPONENT"
      (componentOut_3 \ JsonKey.result \ "status" \JsonKey.selectionCriterion \ "status").asOpt[String].get === "REQUIRE_NEXT_STEP"
      (componentOut_3 \ JsonKey.result \ "status" \JsonKey.excludeDependencyInternal \ "status").asOpt[String] === Some(ExcludedComponentInternal().status)
      ...
      (componentOut_4 \ JsonKey.result \ "status" \"selectedComponent" \ "status").asOpt[String].get === "REMOVED_COMPONENT"
      (componentOut_4 \ JsonKey.result \ "status" \JsonKey.selectionCriterion \ "status").asOpt[String].get === "ALLOW_NEXT_COMPONENT"
      ...
      (componentOut_5 \ JsonKey.result \ "status" \"componentType" \ "status").asOpt[String].get === "DEFAULT_COMPONENT"
      (componentOut_5 \ JsonKey.result \ "status" \"selectedComponent" \ "status").asOpt[String].get === "REMOVED_COMPONENT"
      (componentOut_5 \ JsonKey.result \ "status" \JsonKey.selectionCriterion \ "status").asOpt[String].get === "REQUIRE_COMPONENT"
      (componentOut_5 \ JsonKey.result \ "status" \JsonKey.excludeDependencyInternal \ "status").asOpt[String] === Some(NotExcludedComponentInternal().status)
      (componentOut_5 \ JsonKey.result \ "status" \"common" \ "status").asOpt[String].get === "SUCCESS"
      ...
      (componentOut_6 \ JsonKey.result \ "status" \"componentType" \ "status").asOpt[String].get === "DEFAULT_COMPONENT"
      (componentOut_6 \ JsonKey.result \ "status" \"selectedComponent" \ "status").asOpt[String].get === "ADDED_COMPONENT"
      (componentOut_6 \ JsonKey.result \ "status" \JsonKey.selectionCriterion \ "status").asOpt[String].get === "REQUIRE_NEXT_STEP"
      (componentOut_6 \ JsonKey.result \ "status" \JsonKey.excludeDependencyInternal \ "status").asOpt[String] === Some(NotExcludedComponentInternal().status)
      (componentOut_6 \ JsonKey.result \ "status" \"common" \ "status").asOpt[String].get === "SUCCESS"
      ...
      (componentOut_7 \ JsonKey.result \ "status" \"componentType" \ "status").asOpt[String].get === "DEFAULT_COMPONENT"
      (componentOut_7 \ JsonKey.result \ "status" \"selectedComponent" \ "status").asOpt[String].get === "NOT_ALLOWED_COMPONENT"
      (componentOut_7 \ JsonKey.result \ "status" \JsonKey.selectionCriterion \ "status").asOpt[String].get === "REQUIRE_NEXT_STEP"
      (componentOut_7 \ JsonKey.result \ "status" \JsonKey.excludeDependencyInternal \ "status").asOpt[String] === Some(ExcludedComponentInternal().status)
      (componentOut_7 \ JsonKey.result \ "status" \"common" \ "status").asOpt[String].get === "SUCCESS"
      ...
      (componentOut_8 \ JsonKey.json).asOpt[String].get === JsonNames.SELECTED_COMPONENT
      (componentOut_8 \ JsonKey.result \ "status" \"componentType" \ "status").asOpt[String].get === "DEFAULT_COMPONENT"
      (componentOut_8 \ JsonKey.result \ "status" \"selectedComponent" \ "status").asOpt[String].get === "NOT_ALLOWED_COMPONENT"
      (componentOut_8 \ JsonKey.result \ "status" \JsonKey.selectionCriterion \ "status").asOpt[String].get === "REQUIRE_NEXT_STEP"
      (componentOut_8 \ JsonKey.result \ "status" \JsonKey.excludeDependencyInternal \ "status").asOpt[String] === Some(ExcludedComponentInternal().status)
      (componentOut_8 \ JsonKey.result \ "status" \"common" \ "status").asOpt[String].get === "SUCCESS"
      ...
      ((result_8 \ JsonKey.step \ "components")(0) \ "nameToShow").asOpt[String] === Some("C13")
    }
  }
}