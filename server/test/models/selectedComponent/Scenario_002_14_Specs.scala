...
class Scenario_002_14_Specs extends Specification with MessageHandler with BeforeAfterAll{
  ...
  "Specification spezifiziert der NextStep der Konfiguration" >> {
    "S1 -> C1, C2, C3, C1, C2, C3, C1, C2, C3" >> {
      ...
      ((result_7 \ JsonKey.step \ "components")(0) \ JsonKey.nameToShow).asOpt[String] === Some("C13")
      ...
      ((result_8 \ JsonKey.step \ "components")(0) \ JsonKey.nameToShow).asOpt[String] === Some("C13")
      ...
      (result_9 \ JsonKey.step \ "nameToShow").asOpt[String] === Some("S1")
      (result_9 \ JsonKey.step \ "components").asOpt[List[JsValue]].get.size === 0
    }
  }
}