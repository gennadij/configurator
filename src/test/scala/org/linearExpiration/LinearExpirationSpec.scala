...
class LinearExpirationSpec extends Specification {
  ...
  def e2 = container.currentConfig.size must_==5
  ...
  def e4 = container.currentConfig.size must_==5
  ...
  def e10 = container.currentConfig.size must beEqualTo(5)
