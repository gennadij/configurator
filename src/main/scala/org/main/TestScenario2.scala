...
//    def step1 = {
//      
//      val step = ConfigMgr.getNextStep(Set(new SelectedComponent("S000001C000003")))
//      
...
//      require(ConfigMgr.currentConfig(0).components(0).id == "S000001C000003")
//      require(ConfigMgr.currentConfig(0).components(0).nameToShow == "Component 3")
//    }
//    
//    def step2 = {
//      
//      val step = ConfigMgr.getNextStep(Set(  new SelectedComponent("S000003C000003", 4),
...
//      require(ConfigMgr.currentConfig(1).id == "S000003")
//      require(ConfigMgr.currentConfig(1).nameToShow == "Step 3")
...
//      require(ConfigMgr.currentConfig(1).components(0).id == "S000003C000003")
//      require(ConfigMgr.currentConfig(1).components(0).nameToShow == "Component 3")
...
//      require(ConfigMgr.currentConfig(1).components(1).id == "S000003C000004")
//      require(ConfigMgr.currentConfig(1).components(1).nameToShow == "Component 4")
...
//      require(ConfigMgr.currentConfig(2).id == "S000004")
//      require(ConfigMgr.currentConfig(2).nameToShow == "Step 4")
...
//      require(ConfigMgr.currentConfig(2).components(0).id == "S000004C000002")
//      require(ConfigMgr.currentConfig(2).components(0).nameToShow == "Component 2")
//    }
//    
//    def step4 = {
//      
//      val step = ConfigMgr.getNextStep(Set(new SelectedComponent("S000005C000005"), 
...
//      require(ConfigMgr.currentConfig(3).id == "S000005")
//      require(ConfigMgr.currentConfig(3).nameToShow == "Step 5")
//      require(ConfigMgr.currentConfig(3).components.size == 2)
//      require(ConfigMgr.currentConfig(3).components(1).id == "S000005C000005")
//      require(ConfigMgr.currentConfig(3).components(1).nameToShow == "Component 5")
//      require(ConfigMgr.currentConfig(3).components(0).id == "S000005C000004")
//      require(ConfigMgr.currentConfig(3).components(0).nameToShow == "Component 4")
//    }
//    
//    def step5 = {
//      
//      val step = ConfigMgr.getNextStep(Set(new SelectedComponent("S000008C000002")))
//      
//      require(step.isInstanceOf[ErrorStep] != true, step.errorMessage)
//  
...
//      require(ConfigMgr.currentConfig(4).id == "S000008")
//      require(ConfigMgr.currentConfig(4).nameToShow == "Step 8")
//      require(ConfigMgr.currentConfig(4).components.size == 1)
//      require(ConfigMgr.currentConfig(4).components(0).id == "S000008C000002")
//      require(ConfigMgr.currentConfig(4).components(0).nameToShow == "Component 2")
//    }
//  }
//}